...
class PaypalService
{
    ...
    {
        $order = $this->withdraw($request->amount, $request->account);
    ...
    public function handleWithdrawApproval()
    {
        if (session()->has('approvalId')) {
           ...
           # databse change start
            $withdraw = Withdraw::where('id', session('paypal_withdraw_id'))->first();
    ...
    public function withdraw($value, $email)
    {
        return $this->makeRequest(
            'POST',
            '/v2/checkout/orders',
            ...
            [
                ...
                array(
                    ...
                    array(
                        'amount' =>
                        array(
                            'currency_code' => allSettings('currency_name'),
                            'value' => $value
                        ),
                        'payee' =>
                        array(
