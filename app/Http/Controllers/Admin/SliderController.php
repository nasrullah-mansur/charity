...
class SliderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.slider.index', ['task' => 'List', 'page_title' => 'Slider', 'menu' => 'Home']);
    }
    ...
    public function createStore(Request $request)
    {
        ...
        $campaigns = Campaign::where(['status' => CAMPAIGN_RUNNING, 'is_approved' => true])->where('end_date', '>=', Carbon::now()->toDateString())->get();
        return view('admin.slider.create', ['campaigns' => $campaigns, 'task' => 'Create', 'menu' => 'Home', 'page_title' => 'Slider',]);
    }
    ...
    public function editUpdate(Request $request, $id = null)
    {
        if ($request->isMethod('POST')) {
            ...
            try {
                ...
                return view('admin.slider.edit', ['campaigns' => $campaigns,'slider' => $slider, 'task' => 'Edit', 'page_title' => 'Slider', 'menu' => 'Home']);
