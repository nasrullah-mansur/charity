                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <input class="form-check-input" type="radio" name="post_category"
                                                value="{{STATUS_ACTIVE}}" {{ $category->post_category ? 'checked' : '' }}>
                                            <label class="form-check-label">Yes</label>
                                            <span class="ml-4">
                                            <input class="form-check-input" type="radio" name="post_category"
                                                   value="{{STATUS_INACTIVE}}" {{ $category->post_category ? '' : 'checked' }}>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <input class="form-check-input" type="radio" name="campaign_category"
                                                value="{{STATUS_ACTIVE}}" {{ $category->campaign_category ? 'checked' : '' }}>
                                            <label class="form-check-label">Yes</label>
                                            <span class="ml-4">
                                            <input class="form-check-input" type="radio" name="campaign_category"
                                                   value="{{STATUS_INACTIVE}}" {{ $category->campaign_category ? '' : 'checked' }}>
                                            <label class="form-check-label">No</label>
                                            </span>
                                         </div>
                                    </div>
