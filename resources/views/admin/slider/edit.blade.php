                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2">
                                            <img id="targetoffer1" src="{{ $slider->image }}" width="120" height="80" />
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            ...
                                            @if($slider->campaign)
                                            <option value="{{ $slider->campaign_id }}">{{strlen($slider->campaign->pl_title) > 32 ?  substr($slider->campaign->pl_title, 0, 32).'..' : $slider->campaign->pl_title}}</option>
                                            @else
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6"><div class="form-check">
                                                <input class="form-check-input" type="radio" name="active_status"
                                                    value="{{STATUS_ACTIVE}}" {{ $slider->active_status ?  'checked' : ''}}>
                                                <label class="form-check-label">Active</label>
                                                <span class="ml-4">
                                                <input class="form-check-input" type="radio" name="active_status"
                                                    value="{{STATUS_INACTIVE}}" {{ $slider->active_status ?  '' : 'checked'}}>
