                            ...
                            <ul class="nav nav-tabs border-0" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab"
                                       aria-controls="home" aria-selected="true">{{primaryLang()}}</a>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                                       aria-controls="profile"
                                       aria-selected="false">{{secondaryLang()}}</a>
                                </li>
                            </ul>

                        </div>

                        <form role="form" method="POST" action="{{route('admin.blog.update')}}"
                                     ...
                                     <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <select class="form-control" name="category_id">
                                                        @if ($blog->category_id)
                                                            <option value="{{ $blog->category_id }}">{{ isset($blog->category) ? $blog->category->pl_name : "Category doesn't exists" }}</option>
                                                        @else
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <select class="select2bs4 form-control" multiple="multiple"  name="tag[]">
                                                        ...
                                                        @if (isset($blog->blogTags[0]))
                                                        @foreach ($blog->blogTags as $b_tag )

                                                        <option value="{{ $b_tag->tag->id }}" selected>{{ isset($b_tag->tag) ? $b_tag->tag->pl_name : "Tag doesn't exist"}}</option>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <img id="target_primary_image" src="{{ $blog->primary_image }}" width="120" height="80" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <textarea class="textarea" placeholder="Place some text here"
                                                          ...
                                                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{!! $blog->pl_description_pre_image !!}</textarea>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-2">
                                                    <img id="target_secondary_image" src="{{ $blog->secondary_image }}" width="120" height="80" />
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <textarea class="textarea" placeholder="Place some text here"
                                                          ...
                                                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{!! $blog->pl_description_post_image !!}</textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <textarea class="textarea" placeholder="Place some text here"
                                                          ...
                                                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{!! $blog->sl_description_pre_image !!}</textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    <textarea class="textarea" placeholder="Place some text here"
                                                          ...
                                                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{!! $blog->sl_description_post_image !!}</textarea>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <input class="form-check-input" type="radio" name="active_status"
                                                value="{{STATUS_ACTIVE}}" {{ $blog->active_status ? 'checked' : '' }}>
                                            <label class="form-check-label">Active</label>
                                            <span class="ml-4">
                                            <input class="form-check-input" type="radio" name="active_status"
                                                value="{{STATUS_INACTIVE}}" {{ $blog->active_status ? '' : 'checked' }}>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-8">
                                            <input class="form-check-input" type="radio" name="popular"
                                                value="{{STATUS_ACTIVE}}" {{ $blog->popular ? 'checked' : '' }}>
                                            <label class="form-check-label">Yes</label>
                                            <span class="ml-4">
                                            <input class="form-check-input" type="radio" name="popular"
                                                value="{{STATUS_INACTIVE}}" {{ $blog->popular ? '' : 'checked' }}>
