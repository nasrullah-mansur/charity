          ...
          <div class="password-right-bar">
            <div class="password-table">
              ...
              <div class="password-preference">
                <form action="{{ route('user.stripe.withdraw.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                  ...
                  <div class="password-form">
                    <div class="row">
                      <div class="col-lg-4">
                        <p>{{ translation('stripe_account') }}</p>
                      </div>
                      <div class="col-lg-8">
                        <input type="text" name="stripe_account">
                  ...
                  <div class="password-form">
                    <div class="row">
                      ...
                      <div class="col-lg-8">
                        <input type="text" name="stripe_card_number">
