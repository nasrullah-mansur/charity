...
@section('title', translation('my_campaign') )
@section('post_head')
@section('content')
          ...
          <div class="about-banner-content">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ translation('may_campaign') }}</li>
              </ol>
            </nav>
          </div>
        </div>
        ...
        <div class="col-lg-9">
          <div class="my-campaign-right-bar ">
            <div class="my-campaign-table">
              <h2>{{ translation('may_campaign') }}</h2>
                    ...
                    <tr>
                      ...
                      {{-- <td>
                        @if($campaign->status == CAMPAIGN_PENDIGN )
                            <p class="text-warning">{{ translation('pending_campaign') }}</p>
                        @elseif ($campaign->status == CAMPAIGN_RUNNING )
                        <p class="text-success">{{ translation('running_campaign') }}</p>
                        @elseif ($campaign->status == CAMPAIGN_COMPLETED )
                        <p class="text-secondary">{{ translation('backed_campaign') }}</p>
                        @endif
                      </td> --}}
                      <td>
